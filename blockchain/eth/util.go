...
func (bc blockRefChain) String() string {
	return fmt.Sprintf("chain state(best: %v, oldest: %v)", bc.head(), bc.tail())
}
...
// NewSHA256Hash is a utility function for converting between Ethereum common hashes and turbo hashes
